        ...
        <AuthenticatedLayout
            ...
            header={
                <div>
                    ...
                    <Link href={route('categories.create')} className="text-indigo-600 dark:text-white bg-white border border-gray-200 text-sm dark:border-0 px-4 py-2 rounded dark:bg-indigo-600">Create category</Link>
                </div>
            }
        >
